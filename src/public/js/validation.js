...
function checkFirstnameInput() {
	if(firstnameInput.value == "") {
        ...
        errorMsg[0].textContent = "Введите имя";
...
function checkLastnameInput() {
	if(lastnameInput.value == "") {
        ...
        errorMsg[1].textContent = "Введите фамилию";
...
function checkEmailInput() {
	if(emailInput.value == "") {
        ...
        errorMsg[2].textContent = "Введите почту";
...
function checkPassword() {
	if(passwordInput.value == "") {
        ...
        errorMsg[3].textContent = "Введите пароль";
...
function checkConfirmPassword() {
	if(confirmPasswordInput.value == "") {
        ...
        errorMsg[4].textContent = "Подтвердите пароль";
