...
function init() {
    let paginationCode = `<li class="page-item" id="prev"><button class="page-link" onclick="prevPage()">Назад</button></li>`;
    ...
    paginationCode += `<li class="page-item" id="next"><button type="button" class="page-link" onclick="nextPage()">Вперед</button></li>`;
