...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link <?= (Session::get('controller_name') == 'Home') ? 'active' : '' ?>" href="/">Главная</a>
            </li>

            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle <?= (Session::get('controller_name') == 'Categories') ? 'active' : '' ?>" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Категории</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <?php foreach($categories as $key => $value) : ?>
                        
                        <a class="dropdown-item" href="/category/showCategory/<?= $key ?>"><?= $value ?></a>
            ...
            <li class="nav-item">
                <a class="nav-link <?= (Session::get('controller_name') == 'About') ? 'active' : '' ?>" href="/about">О проекте</a>
            </li>

            <li class="nav-item">
                <a class="nav-link <?= (Session::get('controller_name') == 'Contact') ? 'active' : '' ?>" href="/contact">Контакты</a>
            </li>
        </ul>
