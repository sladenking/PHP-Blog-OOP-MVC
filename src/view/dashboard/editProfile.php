    ...
    <div class="container">
            ...
            <form action="<?php echo URL; ?>dashboard/doUpdateUser" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group inputDnD">
                    <label for="title">Загрузить аватарку: <sup>*</sup></label>
                    <input type="file" class="form-control-file text-upload font-weight-bold" name="new_foto" id="inputFile" onchange="readUrl(this)" data-title="Нажмите для загрузки картинки">
                </div>

                <div class="form-group">
                    <label for="title">Имя: <sup>*</sup></label>
                ...
                <div class="form-group">
                    <label for="title">Фамилия: <sup>*</sup></label>
                ...
                <div class="form-group">
                    <label for="title">Почта: <sup>*</sup></label>
                ...
                <div class="form-group">
                    <label for="title">Новый пароль: <sup>*</sup></label>
                    <input type="password" name="password" Placeholder="Введите пароль" class="form-control form-control-lg <?= $passwordErr ?>">
                    <span class="invalid-feedback"><?= $passwordErrorMsg ?></span>
                </div>

                <div class="form-group">
                    <label for="title">Подтвердите новый пароль: <sup>*</sup></label>
                    <input type="password" name="confirm_password" Placeholder="Введите новый пароль" class="form-control form-control-lg <?= $confirmPasswordErr ?>">
